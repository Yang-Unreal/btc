					...
					<table class="w-full text-left border-collapse">
						<thead>
							<tr class="bg-slate-50/50 border-b border-slate-100 text-xs uppercase tracking-wider text-slate-500">
								...
								<th class="px-6 py-4 font-semibold text-right hidden md:table-cell">
									Volume (24h)
								</th>
							</tr>
						</thead>
								...
								<For each={Array(5).fill(0)}>
									{() => (
										<tr class="animate-pulse">
											...
											<td class="px-6 py-4">
												<div class="h-6 w-20 bg-slate-100 rounded ml-auto"></div>
											</td>
											<td class="px-6 py-4">
												<div class="h-6 w-16 bg-slate-100 rounded ml-auto"></div>
											</td>
											<td class="px-6 py-4">
										...
										<tr class="hover:bg-slate-50/80 transition-colors group">
											<td class="px-6 py-4">
												<div class="flex items-center gap-3">
													<span class="text-slate-400 font-mono text-xs w-4">
														#{asset.rank}
													</span>
													<img
														src={asset.image}
